...
public class ListarIndicadoresFinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_indicadores_fin);

        agregar = findViewById(R.id.agregar_indicador_fin_button);
        listaIndicadores= new ArrayList<>();

        recyclerView = findViewById(R.id.recyclerindicadoresfin);
